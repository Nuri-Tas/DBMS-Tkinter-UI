        ...
        for idx, item in enumerate(id_name_username):
            ...
            if len(session_results) != 0:
                ...
                for session_result in session_results:
                    ...
                    cursor.execute(sql, (session_result[0],))
                    ...
                    copy_row = new_row.copy()
                    copy_row.extend([theatre_id, theatre_district, time_slot])

                    results.append(copy_row)

            else:
                theatre_id, theatre_district, time_slot = None, None, None
                new_row.extend([theatre_id, theatre_district, time_slot])
